...
const validForm = () => {
    ...
    //celular
    if (notEmpty("celular") && !validCelular()){
...
pubEvent.addEventListener("click", () => {
    ...
    document.getElementById("confirmar-btn").addEventListener("click", () => {
        ...
        finalMsgContainer.innerHTML = `
            <p style="font-weight: bold; color: green;">Hemos recibido su información, muchas gracias y suerte en su actividad</p>
            <button type="button" onclick="window.location.href='index.html'">Volver a la portada del sistema</button>
        `;
